...
<div class="row">
	...
	<div class="col-sm-9">
		<div align="center"><h1>临时用户管理</h1></div>
		<div class="col-sm-4">
			<button type="button" class="btn btn-danger disabled" data-toggle="modal" data-target="#DeleteGroupModal">删除已选用户组</button>
		</div>
		<div class="col-sm-4"></div>
		<div class="col-sm-4" align="right">
			<button type="button" class="btn btn-success" data-toggle="modal" data-target="#AddGroupModal">添加临时用户组</button>
		</div>
		<div id="user_group_list">
			<?php include "ajax/tmp_user_list.php"; ?>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">添加临时用户组</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal" id="addgroup" role="form">
					<div class="form-group">
						<label for="addgroup_groupname" class="col-sm-3 control-label">临时用户前缀:</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="addgroup_groupname" placeholder="临时用户前缀">
						</div>
					</div>
					<p>将会自动添加"tmp_"前缀</p>
				</form>
...
<div class="modal fade" id="DeleteGroupModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel">删除临时用户组</h4>
			</div>
			<div class="modal-body">
				<b>你确定要删除以下临时用户组么：</b>
...
<div class="modal fade" id="GroupManageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="myModalLabel">临时用户组管理</h4>
			</div>
...
<script language="javascript">
	...
	function reflash(){
		$.get("/ajax/tmp-user-list", function(data){
